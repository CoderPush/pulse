...
const DailyPulseHistoryTable: React.FC<DailyPulseHistoryTableProps> = ({ monthDays, periodByDate, monthSubmissions, template, questions }) => {
  ...
  }, [expandedKey, periodByDate, monthSubmissions, answers]);
