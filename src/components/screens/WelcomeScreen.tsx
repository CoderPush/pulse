    ...
    >
      ...
      >
        <motion.h1 
          ...
          className="text-3xl font-bold mb-6 flex flex-col items-center gap-2 order-1"
        >
        ...
        <motion.div 
          ...
          className="bg-gradient-to-br from-blue-50 via-purple-50 to-blue-100 p-8 rounded-2xl w-full shadow-lg border border-blue-100 order-4 2xl:order-3 lg:mb-8"
        >
          <motion.h3 
            whileHover={{ scale: 1.02 }}
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          onClick={onNext}
          className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white py-4 px-6 rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all flex items-center justify-center gap-3 group shadow-lg font-bold order-3 2xl:order-4 mb-8 lg:mb-2"
        >
          <motion.span
            animate={{ x: [0, 5, 0] }}
