...
export function getEmailTemplate(type: string, name: string, link: string): string {
  const templates = {
    'initial': `
      ...
      <a href="${link}" style="display: inline-block; padding: 12px 24px; background-color: #4F46E5; color: white; text-decoration: none; border-radius: 4px;">Submit Weekly Pulse</a>
      <p style="color: #6B7280; font-size: 14px; margin-top: 16px;">If you have already submitted your Weekly Pulse, please ignore this email.</p>
    `,
    'on-time': `
    ...
    'late-1': `
      ...
      <a href="${link}" style="display: inline-block; padding: 12px 24px; background-color: #4F46E5; color: white; text-decoration: none; border-radius: 4px;">Submit Now</a>
      <p style="color: #6B7280; font-size: 14px; margin-top: 16px;">If you have already submitted your Weekly Pulse, please ignore this email.</p>
    `,
    'late-2': `
